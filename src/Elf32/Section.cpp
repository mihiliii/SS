...
Section::Section(Elf32File* _elf32_file) :
    elf32_file(_elf32_file), sh_table_index(_elf32_file->sectionHeaderTable().size()) {
...
Elf32_Half Section::index() const { return sh_table_index; }

Elf32_Shdr& Section::header() { return elf32_file->sectionHeaderTable()[sh_table_index]; }
